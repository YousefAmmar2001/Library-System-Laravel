...
class UserPolicy
{
    ...
    {
        return $admin->hasPermissionTo('Read-Users', 'admin')
            ? $this->allow()
            : $this->deny();
    }
    ...
    {
        return $admin->hasPermissionTo('Create-User', 'admin')
            ? $this->allow()
            : $this->deny();
    }
    ...
    {
        return $admin->hasPermissionTo('Update-User', 'admin')
            ? $this->allow()
            : $this->deny();
    }
    ...
    {
        return $admin->hasPermissionTo('Delete-User', 'admin')
            ? $this->allow()
            : $this->deny();
    }
