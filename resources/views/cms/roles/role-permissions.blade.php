...
@section('page-large-name', 'Role Permissions')
                                            ...
                                            <td>
                                                <div class="icheck-primary d-inline">
                                                    ...
                                                    <input type="checkbox" id="permission_{{ $permission->id }}"
                                                        onclick="assignPermission('{{ $role->id }}', '{{ $permission->id }}')"
...
@section('scripts')
    <script>
        function assignPermission(roleId, permissionId) {
            ...
            axios.post('/cms/admin/permissions/role', data).then(function(response) {
